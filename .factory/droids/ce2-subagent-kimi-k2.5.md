---
name: ce2-subagent-kimi-k2.5
description: Generic CHIEF_ENGINEER subagent on Kimi K2.5 — dispatched flexibly per activity / specialty / task at runtime; cheaper model for straightforward narrow-lens work
model: kimi-k2.5
