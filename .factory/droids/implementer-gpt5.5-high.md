---
name: implementer-gpt5.5-high
description: Implementer using GPT-5.5 with high reasoning - implements coding tasks one stage at a time, updates planning doc with learnings
model: gpt-5.5
