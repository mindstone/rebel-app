---
name: ce2-subagent-minimax2.7
description: Generic CHIEF_ENGINEER subagent on MiniMax M2.7 — dispatched flexibly per activity / specialty / task at runtime; cheaper model for straightforward narrow-lens work
model: minimax-m2.7
