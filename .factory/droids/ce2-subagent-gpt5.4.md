---
name: ce2-subagent-gpt5.4
description: Generic CHIEF_ENGINEER subagent on GPT-5.4 — dispatched flexibly per activity / specialty / task at runtime; cheaper mid-tier model for judgment-required-but-not-frontier work
model: gpt-5.4
