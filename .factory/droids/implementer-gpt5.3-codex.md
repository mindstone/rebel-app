---
name: implementer-gpt5.3-codex
description: Implementer using GPT-5.3 Codex with extra high reasoning - implements coding tasks one stage at a time, updates planning doc with learnings
model: gpt-5.3-codex
